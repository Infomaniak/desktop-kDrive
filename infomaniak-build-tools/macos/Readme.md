...
> **Note:** Currently only **xxHash**, **log4cplus**, **Qt**, **OpenSSL**, **libzip**, **SQLite**, **Sentry** and **Poco** are managed via this Conan-based workflow. Additional dependencies will be added in future updates.
