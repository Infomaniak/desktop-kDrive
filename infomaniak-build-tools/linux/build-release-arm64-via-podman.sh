...
podman run --rm -it \
	...
	--arch arm64 \
	ghcr.io/infomaniak/kdrive-desktop-linux@sha256:6060995775c5e7f55034634914f4ff4154ec0cab944acccfac9495894fd917b6 /bin/bash -c "/src/infomaniak-build-tools/linux/build-release-appimage-arm64.sh"
podman machine stop build_kdrive
