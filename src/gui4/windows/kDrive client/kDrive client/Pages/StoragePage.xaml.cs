...
namespace Infomaniak.kDrive.Pages
{
    public sealed partial class StoragePage : Page
    {
        ...
        private string GetThisComputerTitle(string diskRoot, Int64? diskSize)
        {
            ...
            return Localizer.Localizer.GetString("storageThisComputerTitle", diskRoot, prettySize);
        }
        ...
        private string GetStorageUsedLabel(Int64? usedSize)
        {
            ...
            return Localizer.Localizer.GetString("storageUsedLabel", prettySize);
        }
        ...
        private string GetStorageFreeLabel(Int64? usedSize)
        {
            ...
            return Localizer.Localizer.GetString("storageFreeLabel", prettySize);
        }
    }
