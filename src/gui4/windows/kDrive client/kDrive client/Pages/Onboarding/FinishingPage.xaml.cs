...
namespace Infomaniak.kDrive.Pages.Onboarding
{
    public sealed partial class FinishingPage : Page
    {
        ...
        protected async override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            {
                Logger.Log(Logger.Level.Fatal, "OnBoardingViewModel parameter missing when navigating to FinishingPage");
                throw new Exception("OnBoardingViewModel parameter missing when navigating to FinishingPage");
            }
        }
    }
}
