...
namespace KDrive.ViewModels
{
    internal class SyncActivity : ObservableObject
    {
        ...
        private ItemType deduceSyncActivityItemType()
        {
            string extension = System.IO.Path.GetExtension(Name).ToLower();
            return extension switch
            {
                ".doc" or ".docx" or ".odt" => ItemType.Doc,
                ".pdf" => ItemType.Pdf,
                ".png" or ".jpg" or ".jpeg" or ".gif" or ".bmp" or ".tiff" or ".svg" => ItemType.Image,
                ".mp4" or ".avi" or ".mov" or ".wmv" or ".flv" => ItemType.Video,
                ".mp3" or ".wav" or ".aac" or ".flac" => ItemType.Audio,
                ".xls" or ".xlsx" or ".ods" => ItemType.Grid,
                _ => ItemType.File,
            };
