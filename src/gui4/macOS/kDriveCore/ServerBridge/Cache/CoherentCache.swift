...
public protocol CoherentCache: Sendable {
    ...
    func vfsConversionStarted(synchroDbId: Int32) async throws
    func vfsConversionCompleted(synchroDbId: Int32) async throws
    ...
    func updateErrors(_ errors: [ErrorInfo]) async throws
