        ...
        ScrollView {
            VStack(spacing: 0) {
                ErrorExplainingSheetView(
                    ...
                    explanations: InvalidSyncDirAccessReasonsSheet.explanations,
...
#Preview {
    InvalidSyncDirAccessReasonsSheet(synchroErrorManager: SynchroErrorManager(), error: PreviewHelper.synchroError)
}
