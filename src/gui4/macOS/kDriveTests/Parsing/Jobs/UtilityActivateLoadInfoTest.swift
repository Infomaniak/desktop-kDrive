...
@Suite("UtilityActivateLoadInfoTest Job Parsing Test")
struct UtilityActivateLoadInfoTest {
    private let decoder = JSONDecoder()

    var validJobCallbackData: Data {
        let bundle = Bundle(for: TestBundleMarker.self)

        guard let url = bundle.url(forResource: "UTILITY_ACTIVATELOADINFO-success", withExtension: "json") else {
    ...
    @Test("Successfully parses a valid UTILITY_ACTIVATELOADINFO.json")
