...
@Suite("NodeCreateMissingFolders Job Parsing Test")
struct NodeCreateMissingFolders {
    ...
    var validJobCallbackData: Data {
        ...
        guard let url = bundle.url(forResource: "NODE_CREATEMISSINGFOLDERS", withExtension: "json") else {
    ...
    @Test("Successfully parses a valid NODE_CREATEMISSINGFOLDERS.json")
