...
@Suite("UpdaterState Job Parsing Test")
struct UpdaterStateTest {
    ...
    var validJobCallbackData: Data {
        ...
        guard let url = bundle.url(forResource: "UPDATER_STATE", withExtension: "json") else {
    ...
    @Test("Successfully parses a valid UPDATER_STATE.json")
