...
class SyncDb : public Db {
    public:
        ...
        bool name(ReplicaSide side, const NodeId &dbNodeId, SyncName &name, bool &found);
        ...
        bool path(const DbNodeId dbNodeId, SyncPath &dbPath, bool &found, const ReplicaSide side = ReplicaSide::Remote);
