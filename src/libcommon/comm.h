...
// keychain keys for tls client certificate and private key (generated by server, read by client)
inline constexpr char clientCertKeychainKey[] = "kdrive_ipc_tls_client_cert";
inline constexpr char clientKeyKeychainKey[] = "kdrive_ipc_tls_client_key";
// Names for tls certification
...
inline constexpr char msgParamNotificationType[] = "notificationType";
inline constexpr char msgParamNbFiles[] = "nbFiles";
...
inline constexpr char msgParamDriveName[] = "driveName";
...
inline constexpr char msgParamUserChoice[] = "userChoice";
