...
ParametersInfo::ParametersInfo(Language language, bool monoIcons, bool autoStart, bool moveToTrash,
    ...
    _purgeOldLogs(purgeOldLogs), _useBigFolderSizeLimit(useBigFolderSizeLimit), _bigFolderSizeLimit(bigFolderSizeLimit),
...
ParametersInfo::ParametersInfo() :
    ...
    _purgeOldLogs(true), _useBigFolderSizeLimit(true), _bigFolderSizeLimit(500), _darkTheme(false), _showShortcuts(true),
    _dialogGeometry(QMap<QString, QByteArray>()), _maxAllowedCpu(50) {}
