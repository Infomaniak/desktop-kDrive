...
enum class Scope {
    None = 0,
    Sync, // Jobs generated by an ongoing synchronisation
    Extension, // Jobs generated by the LiteSync (file hydration)
    UserInitiated // Jobs generated by a user action (e.g. UI navigation, public link generation, ...)
};
