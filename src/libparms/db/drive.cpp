...
Drive::Drive() :
    ...
    _color(std::string()), _notifications(true), _admin(false), _locked(false), _usedSize(0), _accessDenied(false) {}
...
Drive::Drive(int dbId, int driveId, int accountDbId, const std::string &name, int64_t size, const std::string &color,
    ...
    _color(color), _notifications(notifications), _admin(admin), _locked(false), _usedSize(0), _accessDenied(false) {}
