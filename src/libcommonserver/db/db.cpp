...
bool Db::queryIntValue(const std::string &id, int index, int &value, const int defaultValue /*= 0*/) const {
    return _sqliteDb->queryIntValue(id, index, value, defaultValue);
}

bool Db::queryInt64Value(const std::string &id, int index, int64_t &value, const int64_t defaultValue /*= 0*/) const {
    return _sqliteDb->queryInt64Value(id, index, value, defaultValue);
}

bool Db::queryDoubleValue(const std::string &id, int index, double &value, const double defaultValue /*= 0*/) const {
    return _sqliteDb->queryDoubleValue(id, index, value, defaultValue);
}

bool Db::queryStringValue(const std::string &id, int index, std::string &value, const std::string defaultValue /*= {}*/) const {
    return _sqliteDb->queryStringValue(id, index, value, defaultValue);
}

bool Db::querySyncNameValue(const std::string &id, int index, SyncName &value, const SyncName defaultValue /*= {}*/) const {
