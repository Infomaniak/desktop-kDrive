...
@Suite("NodeSubfoldersTest Job Parsing Test")
struct NodeSubfoldersTest {
    ...
    var validJobCallbackData: Data {
        ...
        guard let url = bundle.url(forResource: "NODE_SUBFOLDERS", withExtension: "json") else {
    ...
    func parseValidSignal() throws {
        ...
        // WHEN
        let nodeInfoList = try decoder.decode(CallbackMessage<NodeSubfoldersResponse>.self, from: signalData).body
            .nodeSubFolderInfoList
