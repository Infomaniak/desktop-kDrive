...
@Suite("UtilityBestVFSTest Job Parsing Test")
struct UtilityBestVFSTest {
    ...
    var validJobCallbackData: Data {
        ...
        guard let url = bundle.url(forResource: "UTILITY_BESTVFSAVAILABLEMODE", withExtension: "json") else {
    ...
    @Test("Successfully parses a valid UTILITY_BESTVFSAVAILABLEMODE.json")
