...
@Suite("NodePathTest Job Parsing Test")
struct NodePathTest {
    ...
    var validJobCallbackData: Data {
        ...
        guard let url = bundle.url(forResource: "NODE_PATH", withExtension: "json") else {
    ...
    func parseValidJobCallback() async throws {
        ...
        // WHEN
        let response = try decoder.decode(CallbackMessage<NodePathResponse>.self, from: callbackData)
