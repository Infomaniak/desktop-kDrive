...
struct SYNCENGINE_EXPORT ServerRequests {
        ...
        static ExitCode setUserExclusionTemplateList(const bool def, const std::vector<ExclusionTemplateInfo> &list);
        static ExitCode setExclusionAppList(const bool def, const std::vector<ExclusionAppInfo> &list);
        static ExitCode setUserExclusionTemplateList(bool def, const QList<ExclusionTemplateInfo> &list);
