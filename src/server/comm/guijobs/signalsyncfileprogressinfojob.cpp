...
#include "signalsyncfileprogressinfojob.h"
...
SignalSyncFileProgressInfoJob::SignalSyncFileProgressInfoJob(int syncDbId, const SyncFileItemInfo &itemInfo, int progress) :
    _syncDbId(syncDbId),
    _itemInfo(itemInfo),
    _progress(progress) {
...
ExitInfo SignalSyncFileProgressInfoJob::serializeOutputParms() {
