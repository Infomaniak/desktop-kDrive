...
static const auto inParamsDriveInfo = "driveInfo";

namespace KDC {

DriveUpdateJob::DriveUpdateJob(std::shared_ptr<CommManager> commManager, int requestId, const Poco::DynamicStruct &inParams,
                               std::shared_ptr<AbstractCommChannel> channel) :
    AbstractGuiJob(commManager, requestId, inParams, channel) {
    _requestNum = RequestNum::DRIVE_UPDATE;
}
...
ExitInfo DriveUpdateJob::serializeOutputParms() {
    return ExitCode::Ok;
}
