...
namespace KDC {
// This job is used to resolve errors conflicts by keeping either the local, the remote or the most recent version of each
// conflicting error, based on the provided dbId list and strategy.
