...
private:
    ...
    ExitCode initSyncPal(const Sync &sync,
    ...
    ExitCode processMigratedSyncOnceConnected(int userDbId, int driveId, Sync &sync,
    ...
    void sendSyncProgressInfo(int syncDbId, SyncStatus status, SyncStep step,
    ...
    static bool vfsStatus(int syncDbId, const SyncPath &itemPath, bool &isPlaceholder, bool &isHydrated, bool &isSyncing, int &progress);
    ...
    static bool vfsUpdateMetadata(int syncDbId, const SyncPath &path, const SyncTime &creationTime, const SyncTime &modtime, const int64_t size, const NodeId &id, std::string &error);
    static bool vfsUpdateFetchStatus(int syncDbId, const SyncPath &tmpPath, const SyncPath &path, int64_t received, bool &canceled, bool &finished);
    ...
    static ExitCode sendShowFileNotification(int syncDbId, const QString &filename, const QString &renameTarget, SyncFileInstruction status, int count);
