...
class ClientGui : public QObject, public std::enable_shared_from_this<ClientGui> {
    ...
    public:
        ...
        bool setCurrentUserDbId(UserDbId userDbId);
        inline UserDbId currentUserDbId() const { return _currentUserDbId; }
        bool setCurrentAccountDbId(AccountDbId accountDbId);
    ...
    private slots:
        ...
        // Sync slots
        void onSyncAdded(const Sync &syncInfo);
        void onSyncUpdated(const Sync &syncInfo);
