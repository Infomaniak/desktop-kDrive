...
struct GuiRequests
{
    ...
    static ExitCode requestToken(const QString &code, const QString &codeVerifier,
    ...
    static ExitCode addSync(int userDbId, int accountId, int driveId, const QString localFolderPath, const QString &serverFolderPath,
    ...
    static ExitCode getSubFolders(int userDbId, int driveId, const QString &nodeId, QList<NodeInfo> &list, bool withPath = false);
    static ExitCode getSubFolders(int driveDbId, const QString &nodeId, QList<NodeInfo> &list, bool withPath = false);
    static ExitCode createMissingFolders(int driveDbId, const QList<QPair<QString, QString>> &serverFolderList, QString &nodeId);
    ...
    static ExitCode isSyncDeletionOnGoing(int syncDbId); // Asks the server wether the synchronization `syncDbId` is being deleted.
};
