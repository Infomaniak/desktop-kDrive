...
StrCpy $ConfirmEndProcess_MESSAGEBOX_TEXT "${APPLICATION_NAME} Prozess(e) gefunden, die gestoppt werden müssen.$\nWollen Sie, dass der Installer diese nun für Sie stoppt?"
StrCpy $ConfirmEndProcess_KILLING_PROCESSES_TEXT "Stoppe ${APPLICATION_NAME} Prozess(e)."
StrCpy $ConfirmEndProcess_KILL_NOT_FOUND_TEXT "Prozess zum Beenden nicht gefunden!"
StrCpy $PageReinstall_NEW_Field_1 "Eine ältere Version von  ${APPLICATION_NAME} ist auf Ihrem System installiert. Sie müssen die aktuelle Version in den Windows-Einstellungen deinstallieren, bevor Sie die neue installieren."
...
StrCpy $PageReinstall_OLD_Field_1 "Eine neuere Version von  ${APPLICATION_NAME} ist bereits installiert! Es wird nicht empfohlen, eine ältere Version zu installieren. Wenn Sie diese ältere Version wirklich installieren möchten, deinstallieren Sie die aktuelle Version in den Windows-Einstellungen."
StrCpy $PageReinstall_SAME_Field_1 "${APPLICATION_NAME} ${VERSION} ist bereits installiert. Wenn Sie diese Version wirklich neu installieren möchten, deinstallieren Sie die aktuelle Version in den Windows-Einstellungen."
...
StrCpy $UNINSTALL_EXTENSION "Deinstallation der kDrive Windows Explorer Erweiterung"
...
StrCpy $INIT_WRONG_VERSION "Inkompatible Windows-Version. Windows 8 oder höher ist erforderlich."
...
StrCpy $PageCustomUninstall_NEW_Field_2 "Nur ${APPLICATION_NAME} App deinstallieren"
StrCpy $PageCustomUninstall_NEW_Field_3 "Deinstalliere die ${APPLICATION_NAME} App und lösche alle Konfigurationen"
StrCpy $PageCustomUninstall_NEW_MUI_HEADER_TEXT_TITLE "Deinstallationsparameter"
StrCpy $PageCustomUninstall_NEW_MUI_HEADER_TEXT_SUBTITLE "Wählen Sie, wie Sie ${APPLICATION_NAME} deinstallieren möchten"