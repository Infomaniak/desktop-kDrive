...
StrCpy $PageReinstall_NEW_Field_1 "An older version of ${APPLICATION_NAME} is installed on your system. You need to uninstall the current version from Windows settings before installing the new one."
...
StrCpy $PageReinstall_OLD_Field_1 "A newer version of ${APPLICATION_NAME} is already installed! It is not recommended that you install an older version. If you really want to install this older version, uninstall the current version from Windows settings."
StrCpy $PageReinstall_SAME_Field_1 "${APPLICATION_NAME} ${VERSION} is already installed. If you really want to re-install this version, uninstall the current version from Windows settings."
...
StrCpy $UNINSTALL_EXTENSION "Uninstalling kDrive Windows Explorer Extension"
...
StrCpy $INIT_WRONG_VERSION "Incompatible Windows version. Windows 8 or higher is required."
...
StrCpy $PageCustomUninstall_NEW_Field_2 "Uninstall ${APPLICATION_NAME} app only"
StrCpy $PageCustomUninstall_NEW_Field_3 "Uninstall ${APPLICATION_NAME} app and delete all configurations"
StrCpy $PageCustomUninstall_NEW_MUI_HEADER_TEXT_TITLE "Uninstallation parameters"
StrCpy $PageCustomUninstall_NEW_MUI_HEADER_TEXT_SUBTITLE "Choose how you want to uninstall ${APPLICATION_NAME}"