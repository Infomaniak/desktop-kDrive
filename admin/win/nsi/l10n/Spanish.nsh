...
StrCpy $ConfirmEndProcess_MESSAGEBOX_TEXT "El/los proceso(s) ${APPLICATION_NAME} debe(n) ser detenido(s).$\n¿Quiere que el instalador lo haga por usted?"
StrCpy $ConfirmEndProcess_KILLING_PROCESSES_TEXT "Deteniendo el/los proceso(s) ${APPLICATION_NAME}."
StrCpy $ConfirmEndProcess_KILL_NOT_FOUND_TEXT "¡Proceso a finalizar no encontrado!"
StrCpy $PageReinstall_NEW_Field_1 "Una versión anterior de ${APPLICATION_NAME} se encuentra instalada en el sistema. Debe desinstalar la versión actual desde la configuración de Windows antes de instalar la nueva."
...
StrCpy $PageReinstall_OLD_Field_1 "Una nueva versión de ${APPLICATION_NAME} ya está instalada. No es recomendable instalar una versión anterior. Si realmente desea instalar esta versión anterior, desinstale la versión actual de la configuración de Windows."
StrCpy $PageReinstall_SAME_Field_1 "${APPLICATION_NAME} ${VERSION} ya está instalado. Si realmente desea reinstalar esta versión, desinstale la versión actual desde la configuración de Windows."
...
StrCpy $UNINSTALL_EXTENSION "Desinstalación de kDrive Windows Explorer Extension"
...
StrCpy $INIT_WRONG_VERSION "Versión de Windows incompatible. Se requiere Windows 8 o superior."
...
StrCpy $PageCustomUninstall_NEW_Field_2 "Desinstalar solo la aplicación ${APPLICATION_NAME}"
StrCpy $PageCustomUninstall_NEW_Field_3 "Desinstale la aplicación ${APPLICATION_NAME} y elimine todas las configuraciones"
StrCpy $PageCustomUninstall_NEW_MUI_HEADER_TEXT_TITLE "Parámetros de desinstalación"
StrCpy $PageCustomUninstall_NEW_MUI_HEADER_TEXT_SUBTITLE "Elige cómo quieres desinstalar ${APPLICATION_NAME}"