...
void TestGuiCommChannel::testSyncAddJob() {
    ...
    auto processFct = [](std::shared_ptr<AbstractGuiJob> job) {
        ...
        syncAddJob->syncInfo() = Sync(1, 1, "/Users/test/kDrive1", "", "test", "999", false, true, VirtualFileMode::Win,
...
void TestGuiCommChannel::testSyncAdd2Job() {
    ...
    auto processFct = [](std::shared_ptr<AbstractGuiJob> job) {
        ...
        syncAdd2Job->syncInfo() = Sync(1, 1, "/Users/test/kDrive1", "", "test", "999", false, true, VirtualFileMode::Win,
                                       "{645FF040-5081-101B-9F08-00AA002F954E}");
    };
