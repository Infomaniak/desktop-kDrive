...
class TestJobManager : public CppUnit::TestFixture, public TestBase {
    ...
    private:
        ...
        const SyncPath localTestDirPath_manyFiles = testhelpers::localTestDirPath() / "test_ci" / "many_files_dir";
        const SyncPath localTestDirPath_pictures = testhelpers::localTestDirPath() / "test_ci" / "test_pictures";
