...
void TestSyncPal::testConflictQueue() {
    std::shared_ptr<Node> localrootNode =
            std::shared_ptr<Node>(new Node(std::nullopt, ReplicaSide::Local, Str(""), NodeType::Directory, OperationType::None,
                                           "lRoot", 1234567890, 1234567890, 12345, nullptr));
    std::shared_ptr<Node> remoterootNode =
            std::shared_ptr<Node>(new Node(std::nullopt, ReplicaSide::Remote, Str(""), NodeType::Directory, OperationType::None,
                                           "rRoot", 1234567890, 1234567890, 12345, nullptr));

    // Move_Move_Source & Move_ParentDelete
    std::shared_ptr<Node> localDirA =
            std::shared_ptr<Node>(new Node(std::nullopt, ReplicaSide::Local, Str("A"), NodeType::Directory, OperationType::None,
                                           "lDirA", 1234567890, 1234567890, 12345, localrootNode));
    std::shared_ptr<Node> localDirB =
            std::shared_ptr<Node>(new Node(std::nullopt, ReplicaSide::Local, Str("B"), NodeType::Directory, OperationType::None,
                                           "lDirB", 1234567890, 1234567890, 12345, localrootNode));
    std::shared_ptr<Node> localFileC1 = std::shared_ptr<Node>(
            new Node(std::nullopt, ReplicaSide::Local, Str("c1"), NodeType::File, OperationType::Move, "lFileC1", 1234567890,
                     1234567890, 12345, localDirB, {"A/c1", localrootNode->id().value()}));
    std::shared_ptr<Node> localFileC2 = std::shared_ptr<Node>(
            new Node(std::nullopt, ReplicaSide::Local, Str("c2"), NodeType::File, OperationType::Move, "lFileC2", 1234567890,
                     1234567890, 12345, localDirB, {"A/c2", localDirA->id().value()}));

    std::shared_ptr<Node> remoteDirA =
            std::shared_ptr<Node>(new Node(std::nullopt, ReplicaSide::Remote, Str("A"), NodeType::Directory, OperationType::None,
                                           "rDirA", 1234567890, 1234567890, 12345, remoterootNode));
    std::shared_ptr<Node> remoteDirB =
            std::shared_ptr<Node>(new Node(std::nullopt, ReplicaSide::Remote, Str("B"), NodeType::Directory,
    ...
    std::shared_ptr<Node> remoteFileC1 = std::shared_ptr<Node>(
            new Node(std::nullopt, ReplicaSide::Remote, Str("c1"), NodeType::File, OperationType::Move, "rFileC1", 1234567890,
                     1234567890, 12345, remoterootNode, {"A/c1", remoteDirA->id().value()}));
    std::shared_ptr<Node> remoteFileC2 = std::shared_ptr<Node>(
            new Node(std::nullopt, ReplicaSide::Remote, Str("c2"), NodeType::File, OperationType::Move, "rlFileC2", 1234567890,
                     1234567890, 12345, remoterootNode, {"A/c2", remoteDirA->id().value()}));

    // Move_Create & Move_Delete
    std::shared_ptr<Node> localFileC4 = std::shared_ptr<Node>(
            new Node(std::nullopt, ReplicaSide::Local, Str("c4"), NodeType::File, OperationType::Move, "lFileC4", 1234567890,
                     1234567890, 12345, localrootNode, {"c3", localrootNode->id().value()}));

    std::shared_ptr<Node> remoteFileC3 =
            std::shared_ptr<Node>(new Node(std::nullopt, ReplicaSide::Remote, Str("c4"), NodeType::File, OperationType::Create,
                                           "rFileC3", 1234567890, 1234567890, 12345, localrootNode));
    std::shared_ptr<Node> remoteFileC4 =
            std::shared_ptr<Node>(new Node(std::nullopt, ReplicaSide::Remote, Str("c3"), NodeType::File, OperationType::Delete,
                                           "rFileC4", 1234567890, 1234567890, 12345, localrootNode));

    // Move_Move_Cycle
    std::shared_ptr<Node> localDirC1 =
            std::shared_ptr<Node>(new Node(std::nullopt, ReplicaSide::Local, Str("c2"), NodeType::Directory, OperationType::None,
                                           "lDirC1", 1234567890, 1234567890, 12345, localrootNode));
    std::shared_ptr<Node> localDirC2 =
            std::shared_ptr<Node>(new Node(std::nullopt, ReplicaSide::Local, Str("c2"), NodeType::Directory, OperationType::None,
                                           "lDirC2", 1234567890, 1234567890, 12345, localrootNode));
    std::shared_ptr<Node> localDirD1 = std::shared_ptr<Node>(
            new Node(std::nullopt, ReplicaSide::Local, Str("D1"), NodeType::Directory, OperationType::Move, "lDirD1", 1234567890,
                     1234567890, 12345, localDirC1, {"D1", localrootNode->id().value()}));
    std::shared_ptr<Node> localDirD2 = std::shared_ptr<Node>(
            new Node(std::nullopt, ReplicaSide::Local, Str("D2"), NodeType::Directory, OperationType::Move, "lDirD2", 1234567890,
                     1234567890, 12345, localDirC2, {"D2", localrootNode->id().value()}));

    std::shared_ptr<Node> remoteDirD1 =
            std::shared_ptr<Node>(new Node(std::nullopt, ReplicaSide::Remote, Str("D1"), NodeType::Directory, OperationType::None,
                                           std::nullopt, 1234567890, 1234567890, 12345, remoterootNode));
    std::shared_ptr<Node> remoteDirD2 =
            std::shared_ptr<Node>(new Node(std::nullopt, ReplicaSide::Remote, Str("D2"), NodeType::Directory, OperationType::None,
                                           std::nullopt, 1234567890, 1234567890, 12345, remoterootNode));
    std::shared_ptr<Node> remoteDirC1 = std::shared_ptr<Node>(
            new Node(std::nullopt, ReplicaSide::Remote, Str("c2"), NodeType::Directory, OperationType::Move, std::nullopt,
                     1234567890, 1234567890, 12345, remoteDirD1, {"C1", localrootNode->id().value()}));
    std::shared_ptr<Node> remoteDirC2 = std::shared_ptr<Node>(
            new Node(std::nullopt, ReplicaSide::Remote, Str("c2"), NodeType::Directory, OperationType::Move, std::nullopt,
                     1234567890, 1234567890, 12345, remoteDirD2, {"C2", localrootNode->id().value()}));
